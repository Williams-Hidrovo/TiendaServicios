...
namespace TiendaServicios.Api.Gateway
{
    public class Startup
    {
        ...
        public async void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //3. agregar useOcelop y hacer el metodo asincrono
            await app.UseOcelot();
        }
    }
}
